...
# (project=scitex-math, owner=ywatanabe1989, repo=scitex-math,
...
TMPDIR="/tmp/publish-scitex_math-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-math dist/* uploaded to PyPI via manual OIDC trusted publishing"
