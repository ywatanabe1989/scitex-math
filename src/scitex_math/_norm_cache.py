...
# File: ./src/scitex_math/_norm_cache.py
"""Cached normalization functions for improved performance on repeated operations.

Ported from scitex_gen._numeric._norm_cache (Phase B retirement wave).
"""
...
def patch_normalization_functions():
    ...
    import scitex_math._norm as norm_module
    ...
    try:
        import scitex_math as math_module

        math_module.to_z = to_z_cached
        math_module.to_01 = to_01_cached
    except ImportError:
        pass
